...
public class SpinnerTest extends InteractiveTestBase implements Runnable {
    ...
    private final static File TEMP_DIR = Maven.getTempTestDir(SpinnerTest.class);
     ...
     *            number of segments
     * @param f
     *            fraction of angular extent covered
     */
    ...
    public static void drawSlicedArcSegment(Graphics2D g, double w, double h, double start, double extent) {
        ...
        g.fill(arc);
        padding += w / 10.;
        arc = new Arc2D.Double(padding, padding, w - 2 * padding, h - 2 * padding, start - extent / 2., 360.,
            Arc2D.PIE);
        Color c = g.getColor();
    ...
    protected void produceAnimatedGif(File output, Dimension gifSize, int nFrames, double durationMillis,
        RunnableImageProducer r) throws IOException, InvocationTargetException, InterruptedException {
    ...
    public void testSpinner1()
        ...
        produceAnimatedGif(new File(TEMP_DIR, "animated1.gif"), gifSize, nFrames / 4, durationMillis / 4,
            new RunnableImageProducer() {
    ...
    public void testSpinner4()
        ...
        produceAnimatedGif(new File(TEMP_DIR, "animated4.gif"), gifSize, nFrames, durationMillis,
            new RunnableImageProducer() {
    ...
    public void testSpinner3()
        ...
        produceAnimatedGif(new File(TEMP_DIR, "animated3.gif"), gifSize, nFrames, durationMillis,
            new RunnableImageProducer() {
    ...
    public void testSpinner2()
        ...
        produceAnimatedGif(new File(TEMP_DIR, "animated2.gif"), gifSize, nFrames, durationMillis,
            new RunnableImageProducer() {
